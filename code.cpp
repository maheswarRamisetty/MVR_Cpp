...
public:
    ...
    float rating;
    string theaterid;
    vector<pair<Movie, vector<Time>>> allMoviesdetail;
    string location;
    long long totalCollection;
    
    Theater(string b, float r, string id, vector<pair<Movie, vector<Time>>> m, string loc, long long tc) : brand(b), rating(r), theaterid(id), allMoviesdetail(m), location(loc), totalCollection(tc) {}
};
    ...
    void displayCityInformation()
    {
        ...
        for (const Theater &theater : allTheater)
        {
            ...
            for (const auto &movieDetails : theater.allMoviesdetail)
            {
                ...
                const vector<Time> &Time = movieDetails.second;
...
int main()
{
    ...
    vector<Time> t1 = {Time{"9:00", "1"}, Time{"12:00", "2"}};
    vector<Time> t2 = {Time{"15:00", "3"}, Time{"18:00", "1"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail1 = {{{m1, t1}, {m2, t2}}};
    ...
    vector<Time> t3 = {Time{"10:00", "1"}, Time{"13:00", "2"}};
    vector<Time> t4 = {Time{"16:00", "3"}, Time{"19:00", "1"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail2 = {{{m3, t3}, {m4, t4}}};
    ...
    vector<Time> t5 = {Time{"10:00", "1"}, Time{"13:00", "2"}};
    vector<Time> t6 = {Time{"16:00", "3"}, Time{"19:00", "1"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail3 = {{{m5, t5}, {m6, t6}}};
    ...
    vector<Time> t7 = {Time{"11:00", "1"}, Time{"14:00", "2"}};
    vector<Time> t8 = {Time{"17:00", "3"}, Time{"20:00", "1"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail4 = {{{m7, t7}, {m8, t8}}};
    ...
    vector<Time> t9 = {Time{"9:00", "1"}, Time{"12:00", "2"}};
    vector<Time> t10 = {Time{"15:00", "3"}, Time{"18:00", "1"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail5 = {{{m9, t9}, {m10, t10}}};
    Theater th5("Sathyam Cinemas", 4.3, "T5", allMoviesdetail5, "Location5", 1300000);

    Movie m11("Kaithi", "Tamil", 147, 8.5);
    vector<Time> t11 = {Time{"10:30", "1"}, Time{"13:30", "2"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail6 = {{{m11, t11}}};
    ...
    vector<Time> t12 = {Time{"9:30", "1"}, Time{"12:30", "2"}};
    vector<Time> t13 = {Time{"15:30", "3"}, Time{"18:30", "1"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail7 = {{{m12, t12}, {m13, t13}}};
    Theater th7("INOX", 4.5, "T7", allMoviesdetail7, "Location7", 1200000);

    Movie m14("Chirodini Tumi Je Amar", "Bengali", 159, 7.9);
    vector<Time> t14 = {Time{"10:00", "1"}, Time{"13:00", "2"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail8 = {{{m14, t14}}};
    ...
    vector<Time> t15 = {Time{"10:30", "1"}, Time{"13:30", "2"}};
    vector<Time> t16 = {Time{"16:30", "3"}, Time{"19:30", "1"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail9 = {{{m15, t15}, {m16, t16}}};
    Theater th9("PVR", 4.4, "T9", allMoviesdetail9, "Location9", 1400000);

    Movie m17("Bell Bottom", "Kannada", 140, 7.8);
    vector<Time> t17 = {Time{"9:00", "1"}, Time{"12:00", "2"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail10 = {{{m17, t17}}};
    ...
    vector<Time> t18 = {Time{"11:00", "1"}, Time{"14:00", "2"}};
    vector<Time> t19 = {Time{"17:00", "3"}, Time{"20:00", "1"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail11 = {{{m18, t18}, {m19, t19}}};
    Theater th11("INOX", 4.3, "T11", allMoviesdetail11, "Location11", 1100000);

    Movie m20("Pushpa", "Telugu", 167, 8.5);
    vector<Time> t20 = {Time{"9:30", "1"}, Time{"12:30", "2"}};
    vector<pair<Movie, vector<Time>>> allMoviesdetail12 = {{{m20, t20}}};
                ...
                if (choice == 3)
                {
                    ...
                    if (selectedCity != nullptr)
                    {
                        ...
                        if (selectedTheater != nullptr)
                        {
                            ...
                            selectedTheater->allMoviesdetail.push_back({m, Time});
                        ...
                        if (cityChoice >= 1 && cityChoice <= allCity.size())
                        {
                            ...
                            if (theaterChoice >= 1 && theaterChoice <= selectedCity.allTheater.size())
                            {
                                    ...
                                    timingIndex >= 1 && timingIndex <= selectedTheater.allMoviesdetail.begin()->second.size())
                                {
                                    ...
                                    const Time &selectedTiming = selectedTheater.allMoviesdetail[movieIndex - 1].second[timingIndex - 1];
